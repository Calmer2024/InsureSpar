      ...
      >
        ...
        >
          ...
          <div class="space-y-3">
            ...
            >
              <img :src="personaAvatar(p)" :alt="`${p.name}头像`" class="w-10 h-10 rounded-xl object-cover border border-[var(--color-border-light)] shrink-0 group-hover:scale-105 transition-transform" />
